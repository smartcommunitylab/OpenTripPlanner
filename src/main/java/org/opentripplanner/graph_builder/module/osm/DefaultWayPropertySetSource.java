...
public class DefaultWayPropertySetSource implements WayPropertySetSource {
    ...
    public WayPropertySet getWayPropertySet() {
        ...
        setProperties(props, "highway=tertiary", StreetTraversalPermission.ALL, 1, 1); // 1,1
        setProperties(props, "highway=tertiary_link", StreetTraversalPermission.ALL, 1, 1); // 1,1
